...
open_project -reset ethernet_status_hls_project
set_top ethernet_status_hls
add_files [file join $flow_dir src ethernet_status_hls.cpp]
add_files -tb [file join $flow_dir tb ethernet_status_hls_tb.cpp]
...
puts "HLS RTL: [file join $out_dir ethernet_status_hls_project solution1 syn verilog ethernet_status_hls.v]"
puts "HLS IP:  [file join $out_dir ethernet_status_hls_project solution1 impl ip]"
